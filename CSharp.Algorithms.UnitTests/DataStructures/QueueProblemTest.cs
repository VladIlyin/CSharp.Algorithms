using CSharp.Algorithms.Problems.DataStructures.Queue;
using static CSharp.Algorithms.Problems.DataStructures.Queue.QueueProblem;
...
namespace CSharp.Algorithms.UnitTests.DataStructures
{
    public class QueueProblemTest
    {
        ...
        {
            Assert.Equal(expected, QueueProblem.PredictPartyVictory(senate));
        }
    }
}
